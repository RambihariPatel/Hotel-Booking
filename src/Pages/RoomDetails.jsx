...
const RoomDetails = () => {
  ...
  console.log("All Rooms:", roomsDummyData)
  ...
  if (!room) {
    return <div className="pt-28 text-center text-2xl">Loading...</div>;
  }

  return (
    room && (
      <div className="p-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        {/* Room Details */}
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            city feeling. The price quoted is for two guest, at tyhe guest slot
            please mark the number of guests to get the exact price for groups.
            The Guests will bhe allocated ground floor according to
