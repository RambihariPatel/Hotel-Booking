...
const AllRooms = () => {
  ...
  return (
    <div className="pt-24">  
      ...
      justify-between px-4 md:px-16 lg:px-24'>
        ...
        <div>
          ...
          <div className="flex flex-col items-start text-left">
             ...
             <p className="text-sm md:text-base text-gray-500/90 mt-2 max-w-174">Take advantage of our limited-time offers and special and packages to enhance your stay and create unforgettable memories.</p>
         ...
         {roomsDummyData.map((room) => (
            <div key={room._id} className="flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0">
               ...
               <div className="md:w-1/2 flex flex-col gap-2">
                ...
                className="text-gray-800 text-3xl font-flayfair cursor-pointer">{room.hotel.name}</p>
