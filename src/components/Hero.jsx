...
const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-center px-6 md: px-16 lg:px-24 lg:px-32 text-white
      ...
      <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and comfort await at the world's mpst exclusive hotels and resorts. Start your journey today.</p>
