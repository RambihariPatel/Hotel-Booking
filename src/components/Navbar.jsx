        ...
        {user ? (
          <>
            <button
              ...
              className="flex items-center gap-2 border px-4 py-1 text-sm font-light rounded-full cursor-pointer transition-all"
            >
              <BookIcon />
              My Bookings
            </button>

            {/* Profile avatar – image upload/change inside */}
